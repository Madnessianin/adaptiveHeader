...
var createElementLi = function (
  ...
  if (isAction) {
    conteiner.appendChild(
      createElement(
        elem,
        createActionEditState(item, "menu_link_active", elem),
        classList,
        isTitle
      )
    );
...
var loadData = function () {
  ...
  createListElemLi(
    ...
    "nav_link",
    false
  ); // Создание левой группы элементов
  ...
  createListElemLi(
    ...
    false,
    classListNavLink,
    "nav_link nav_link--right",
    false
  ); // Создание правой группы элементов
};
...
var createMenu = function () {
  ...
  createListElemLi(
    editIdElement(json.iconsLeft, "_menu"),
    menuLeft,
    true,
    classListNavMenuLink,
    "nav_menu_link",
